...
class ArtGallery {
protected: 
    sf::RenderWindow window; //rendering window to render and open my art objects in my window

public:
    virtual void display() = 0; //clear virtual function and it must be implemented in subclass
...
class Painting : public ArtGallery {
private:
    sf::Texture texture1;
    sf::Sprite sprite1;
    sf::Texture texture2;
